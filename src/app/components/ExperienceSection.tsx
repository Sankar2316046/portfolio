  ...
  const timeline = [
    {
      ...
      title: 'SSLC',
      organization: 'Jaya matric hr sec school',
      date: '2021',
      description: 'Completed 10th grade (SSLC) with all subjects passed, laying a strong foundation in mathematics, science, and languages.',
      type: 'education',
    },
    {
      icon: <GraduationCap className="w-6 h-6" />,
      ...
      organization: 'Jaya matric hr sec school',
      date: '2023',
      description: 'Completed 12th grade (HSC) with 509/600 marks, focusing on mathematics and computer science.',
      type: 'education',
    },
    {
      icon: <GraduationCap className="w-6 h-6" />,
      ...
      date: 'pursuing',
      description: 'Pursuing Bachelor of Engineering in Computer Science at S.A Engineering College with a current CGPA of 9.04, specializing in software development and modern technologies.',
      type: 'education',
    },
     {
      icon: <Briefcase className="w-6 h-6" />,
      title: 'Full Stack Developer Intern',
      organization: 'Webzenith Solutions',
      date: 'Dec 2025 - Now',
